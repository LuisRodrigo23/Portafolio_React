    ...
    return (
        <> <section id="services" className="sm:p-10 lg:p-20 p-5 ">
            <div className="container mx-auto">
                ...
                <div className="sm:grid grid-cols-1 max-[1250px]:grid-cols-1">
                    <div className="sm:p-10 p-5 bg-gray-50 sm:me-5 mb-10 rounded-md hover:shadow-md h-[auto] ">
                        ...
                        <p className="leading-10 text-gray-500 text-2xl max-[750px]:text-[18px]">
                        ...
                        <div className="mt-5">
                            <img className="w-[auto] h-[auto] rounded-md" src="../src/img/imgFt1.jpg" alt="Graphic Design" />
                        </div>
                    </div>
                </div>
            </div>
